...
<div class="form-container">
    ...
    <form name="write" method="post" action="/product/write" enctype="multipart/form-data">
        <table>
            <tr><td>주류 <input type="text" name="pname"></td></tr>
            <tr><td>주류 가격 <input type="text" name="pprice"></td></tr>
            <tr><td>알코올 도수 <input type="text" name="palcohol"></td></tr>
            <tr><td>용량 <input type="text" name="psize"></td></tr>
            <tr><td>이미지 <input type="file" name="uploadfile1"></td></tr>
            <tr>
                <td>카테고리
            ...
            <tr><td>재고수 <input type="text" name="pcount"></td></tr>
            <tr><td>상세정보 <textarea name="pdetail"></textarea></td></tr>
            <tr><td>추천 안주 <textarea name="ppairing"></textarea></td></tr>
            <tr><td>추천 안주 이미지 <input type="file" name="uploadfile2"></td></tr>
            <tr>
                <td>
